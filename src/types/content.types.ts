...
/**
 * GameZone page configuration.
 * @description Configuration for the GameZone page, including metadata and navigation label.
 */
export interface GameZone extends BasePageConfig {}

/**
 * Lab experiment item configuration.
 * @description Configuration for individual lab experiments/cards.
 */
export interface LabExperiment {
  ...
  category: "visual" | "coding" | "animation" | "learning" | "ai";
  /** Card orientation - horizontal (wide) or vertical (tall) */
  orientation: "horizontal" | "vertical";
  /** Link to the experiment (internal or external) */
  href?: string;
  /** Tags for the experiment */
  tags?: string[];
  /** Experiment status - reflects the experimental nature of the lab */
  status: "successful" | "in-progress" | "risky" | "destroyed" | "brewing";
}

/**
 * Lab page configuration.
 * @description Configuration for the Lab page - visual experiments, coding experiments, animations, and learnings.
 */
